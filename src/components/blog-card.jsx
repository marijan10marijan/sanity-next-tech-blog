...
const BlogCard = ({ blog, isPopularBlog }) => {
  return (
    <Link
      href={`/blog/${blog.slug}`}
      className={`${isPopularBlog ? "flex-col gap-4 pt-0 px-2  sm:items-start" : "flex sm:flex-col gap-2 overflow-hidden items-center sm:items-start shadow-sm hover:dark:shadow-gray-300 hover:shadow-gray-800 transition duration-150 shadow-gray-600 rounded-md"}`}
    >
      <div
